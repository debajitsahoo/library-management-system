...
ForXieImg = ForXieImg.subsample(2,2)

Xieimg = PhotoImage(file='xielogoblack.png')
Xieimg = Xieimg.subsample(6,6)
...
def loginbtnfunc():                                     #Login Button Function
    ...
    if (user == "" or passw == ""):
        ...
        try:
            con = pymysql.connect(host='localhost', user='admin', password='')
            mycursor = con.cursor()
            query = 'use library;'
...
can.create_text((370,289),text = "Username :",font=('times', 15 , 'bold'), fill="#FFFFFF")

can.create_image((297,358),image = passwordimg ,anchor = 'nw')

can.create_text((370,368), text="Password :", font=('times', 15, 'bold'), fill="#FFFFFF")
